...
public class ItsmServiceItemsTarget implements Serializable {
    /**
     * 
     */
     ...
     * 是否经过服务台 0-否, 1-是
     */
    private Boolean enablePassServiceDesk;
     ...
     * 是否经过服务台 0-否, 1-是
     */
    public Boolean getEnablePassServiceDesk() {
        return enablePassServiceDesk;
    }

    /**
     * 是否经过服务台 0-否, 1-是
     */
    public void setEnablePassServiceDesk(Boolean enablePassServiceDesk) {
        this.enablePassServiceDesk = enablePassServiceDesk;
    }
    ...
    public boolean equals(Object that) {
        ...
        ItsmServiceItemsTarget other = (ItsmServiceItemsTarget) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getEnablePassServiceDesk() == null ? other.getEnablePassServiceDesk() == null : this.getEnablePassServiceDesk().equals(other.getEnablePassServiceDesk()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getEnablePassServiceDesk() == null) ? 0 : getEnablePassServiceDesk().hashCode());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(", enablePassServiceDesk=").append(enablePassServiceDesk);
