...
public class ItsmTaskTarget implements Serializable {
     ...
     * 人员为空时：1跳过该节点，2交给超级管理员
     */
    public Integer getNobodyToDealWith() {
        return nobodyToDealWith;
    }

    /**
     * 人员为空时：1跳过该节点，2交给超级管理员
     */
    public void setNobodyToDealWith(Integer nobodyToDealWith) {
        this.nobodyToDealWith = nobodyToDealWith;
    }

    /**
     * 分配给：1请求人的主管，2组织架构中的主管
     */
    public Integer getSelectSupervisorType() {
        return selectSupervisorType;
    }

    /**
     * 分配给：1请求人的主管，2组织架构中的主管
     */
    public void setSelectSupervisorType(Integer selectSupervisorType) {
        this.selectSupervisorType = selectSupervisorType;
    }

    /**
     * 选择主管层级（1~10）
     */
    public Long getSelectSupervisorVal() {
        return selectSupervisorVal;
    }

    /**
     * 选择主管层级（1~10）
     */
    public void setSelectSupervisorVal(Long selectSupervisorVal) {
        this.selectSupervisorVal = selectSupervisorVal;
    }

    /**
     * dpa入参类型 1:字段 2:表格
     */
    public Integer getDpaRequestParamsType() {
        return dpaRequestParamsType;
    }

    /**
     * dpa入参类型 1:字段 2:表格
     */
    public void setDpaRequestParamsType(Integer dpaRequestParamsType) {
        this.dpaRequestParamsType = dpaRequestParamsType;
    }

    /**
     * 表格列表
     */
    public String getDpaRequestTable() {
        return dpaRequestTable;
    }

    /**
     * 表格列表
     */
    public void setDpaRequestTable(String dpaRequestTable) {
        this.dpaRequestTable = dpaRequestTable;
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getNobodyToDealWith() == null) ? 0 : getNobodyToDealWith().hashCode());
        result = prime * result + ((getSelectSupervisorType() == null) ? 0 : getSelectSupervisorType().hashCode());
        result = prime * result + ((getSelectSupervisorVal() == null) ? 0 : getSelectSupervisorVal().hashCode());
        result = prime * result + ((getDpaRequestParamsType() == null) ? 0 : getDpaRequestParamsType().hashCode());
        result = prime * result + ((getDpaRequestTable() == null) ? 0 : getDpaRequestTable().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", nobodyToDealWith=").append(nobodyToDealWith);
        sb.append(", selectSupervisorType=").append(selectSupervisorType);
        sb.append(", selectSupervisorVal=").append(selectSupervisorVal);
        sb.append(", dpaRequestParamsType=").append(dpaRequestParamsType);
        sb.append(", dpaRequestTable=").append(dpaRequestTable);
