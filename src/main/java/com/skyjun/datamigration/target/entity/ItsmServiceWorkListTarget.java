...
public class ItsmServiceWorkListTarget implements Serializable {
     ...
     * 关闭表单规则是否开启
     */
    public Byte getCloseFormRule() {
        return closeFormRule;
    }

    /**
     * 关闭表单规则是否开启
     */
    public void setCloseFormRule(Byte closeFormRule) {
        this.closeFormRule = closeFormRule;
    }

    /**
     * 影响范围名称
     */
    public String getInfluenceRangeName() {
        return influenceRangeName;
    }

    /**
     * 影响范围名称
     */
    public void setInfluenceRangeName(String influenceRangeName) {
        this.influenceRangeName = influenceRangeName;
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCloseFormRule() == null) ? 0 : getCloseFormRule().hashCode());
        result = prime * result + ((getInfluenceRangeName() == null) ? 0 : getInfluenceRangeName().hashCode());
        result = prime * result + ((getOperationStatus() == null) ? 0 : getOperationStatus().hashCode());
        result = prime * result + ((getUrgentLevelName() == null) ? 0 : getUrgentLevelName().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", closeFormRule=").append(closeFormRule);
        sb.append(", influenceRangeName=").append(influenceRangeName);
        sb.append(", operationStatus=").append(operationStatus);
        sb.append(", urgentLevelName=").append(urgentLevelName);
