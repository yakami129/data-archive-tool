...
public class ItsmPersonTarget implements Serializable {
    /**
     * 
     */
     ...
     * 用户登陆类型
     */
    private Integer personLoginType;

    /**
     * ldap同步版本号
     */
    private Long ldapSyncVersion;
     ...
     * 用户登陆类型
     */
    public Integer getPersonLoginType() {
        return personLoginType;
    }

    /**
     * 用户登陆类型
     */
    public void setPersonLoginType(Integer personLoginType) {
     ...
     * ldap同步版本号
     */
    public Long getLdapSyncVersion() {
        return ldapSyncVersion;
    }

    /**
     * ldap同步版本号
     */
    public void setLdapSyncVersion(Long ldapSyncVersion) {
        this.ldapSyncVersion = ldapSyncVersion;
    }
    ...
    public boolean equals(Object that) {
        ...
        ItsmPersonTarget other = (ItsmPersonTarget) that;
        return (this.getItsmId() == null ? other.getItsmId() == null : this.getItsmId().equals(other.getItsmId()))
            ...
            && (this.getPersonLoginType() == null ? other.getPersonLoginType() == null : this.getPersonLoginType().equals(other.getPersonLoginType()))
            && (this.getLdapSyncVersion() == null ? other.getLdapSyncVersion() == null : this.getLdapSyncVersion().equals(other.getLdapSyncVersion()))
            && (this.getLdapId() == null ? other.getLdapId() == null : this.getLdapId().equals(other.getLdapId()))
            && (this.getOperateObj() == null ? other.getOperateObj() == null : this.getOperateObj().equals(other.getOperateObj()))
            && (this.getLdapLoginName() == null ? other.getLdapLoginName() == null : this.getLdapLoginName().equals(other.getLdapLoginName()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getPersonLoginType() == null) ? 0 : getPersonLoginType().hashCode());
        result = prime * result + ((getLdapSyncVersion() == null) ? 0 : getLdapSyncVersion().hashCode());
        result = prime * result + ((getLdapId() == null) ? 0 : getLdapId().hashCode());
        result = prime * result + ((getOperateObj() == null) ? 0 : getOperateObj().hashCode());
        result = prime * result + ((getLdapLoginName() == null) ? 0 : getLdapLoginName().hashCode());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(", personLoginType=").append(personLoginType);
        sb.append(", ldapSyncVersion=").append(ldapSyncVersion);
        sb.append(", ldapId=").append(ldapId);
        sb.append(", operateObj=").append(operateObj);
        sb.append(", ldapLoginName=").append(ldapLoginName);
